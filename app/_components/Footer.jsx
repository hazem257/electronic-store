...
function Footer() {
  ...
  return !isLoggedIn &&  (
<footer className="bg-white font-mono font-semibold">
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
      <div className="text-center sm:text-left">
        <p className="text-lg font-bold text-btn2">About Us</p>
      ...
      <div className="text-center sm:text-left">
        <p className="text-lg font-bold text-btn2">Our Services</p>
      ...
      <div className="text-center sm:text-left">
        <p className="text-lg font-bold text-btn2">Resources</p>
      ...
      <div className="text-center sm:text-left">
        <p className="text-lg font-bold text-btn2">Helpful Links</p>
    ...
    <div className="mt-16">
      <ul className="flex justify-center gap-6 sm:justify-end">
        ...
        <li>
          <a
            href="https://www.linkedin.com/in/hazem-gamal-2a145b320/"
            rel="noreferrer"
            target="_blank"
            className="text-teal-700 transition hover:text-teal-700/75"
          >
      ...
      <div className="mt-16 sm:flex sm:items-center sm:justify-between">
        ...
        <p className="mt-4 text-center text-sm text-gray-500 sm:mt-0 sm:text-right">
          Copyright &copy; 2024. All rights reserved By Hazem.
        </p>
      </div>
    </div>
  </div>
