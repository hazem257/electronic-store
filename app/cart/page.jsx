  ...
  <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
    <div className="mx-auto max-w-3xl">
      <header className="text-center">
        <h1 className="text-xl  text-gray-900 sm:text-3xl font-mono font-bold">Your Cart</h1>
      </header>
      ...
      <div className="mt-8">
          ...
          {cart?.map((item)=>(
            ...
            <div>
              ...
              <dl className="mt-0.5 space-y-px text-[10px] text-gray-600">
                <div>
                  <dt className="inline font-mono">Category:</dt>
                  <dd className="inline font-mono">{item?.product?.attributes?.category}</dd>
                </div>
          ...
          <div className="w-screen max-w-lg space-y-4">
            ...
            <div className="flex justify-end">
              <button
                ...
                className="block font rounded bg-btn1 px-5 py-3 text-sm text-gray-100 transition hover:bg-sky-900 "
              >
                Checkout
              </button>
            </div>
        ...
        <h2 className='my-4 font-mono font-bold text-2xl bg-slate-500 rounded-3xl text-teal-50'><center>Note:All Products Will be Sent Vai Your Email</center></h2>
      </div>
    </div>
  </div>
</section>
